export default function TopNavBar() {
  return (
    <header className="sticky top-0 z-50 w-full max-w-container-max mx-auto flex justify-between items-center h-20 px-margin-desktop bg-surface border-b border-surface-variant shadow-sm">
