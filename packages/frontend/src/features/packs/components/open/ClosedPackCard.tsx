    ...
    <div className="flex w-full flex-col items-center justify-center gap-8 px-4 pt-2 pb-8 sm:flex-row sm:flex-nowrap sm:gap-10 sm:px-6 sm:pt-12 sm:pb-10">
      ...
      <div className="flex w-full max-w-sm flex-col items-center text-center sm:w-fit sm:max-w-none">
        ...
        <button
          onClick={onOpen}
          disabled={isLoading}
          className="flex cursor-pointer items-center justify-center gap-2.5 rounded-xl border-none bg-linear-to-br from-violet-500 to-violet-700 px-9 py-3.5 text-[15px] font-extrabold text-white transition hover:brightness-105 active:scale-[0.98] disabled:cursor-not-allowed disabled:opacity-60 sm:w-auto"
        >
